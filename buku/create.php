...
if(!empty($_POST['isbn'])){
    ...
    // redirect
    echo '<script>alert("Berhasil Menambahkan Data Buku");window.location="all.php"</script>';
}
?>
    <!DOCTYPE HTML>
    <html>
    ...
    <body>
    <div class="container" style="background-color: #00bf00">
        <br/>
        <h3>Insert Buku</h3>
        <br/>
        <div class="row">
            <div class="col-lg-6">
                <form action="" method="POST">
                    ...
                    <button class="btn btn-danger btn-md" name="create"><i class="fa fa-plus"> </i> Create</button>
                </form>
            </div>
        </div>
    </div>
