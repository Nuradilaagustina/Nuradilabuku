...
if(!empty($_POST['isbn'])){
    ...
    // redirect
    echo '<script>alert("Berhasil Update Data");window.location="all.php"</script>';
}
    ...
    <div class="row">
        <div class="col-lg-6">
            <form action="" method="POST">
                ...
                <button class="btn btn-danger btn-md" name="create"><i class="fa fa-edit"> </i> Update</button>
            </form>
        </div>
    </div>
</div>
